...
<button class="btn btn-secondary" onclick="openAvatarGallery()">
Choisir un avatar</button>
<button class="btn btn-secondary" onclick="openAvatarUpload()">
Uploader ma photo</button>
            </div>
        </div>
    </div>
...
onsubmit="updateProfile(event)">
            <div class="form-group">
                ...
                <input type="text" id="profileUsername" value="<?php echo
htmlspecialchars($user['username']); ?>" required>
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" id="profileEmail" value="<?php echo
htmlspecialchars($user['email']); ?>" required>
            </div>
            <div class="form-group">
                <label>Bio</label>
                <textarea id="profileBio" rows="4" placeholder="Parlez-nous de vous
et de vos goûts en lecture..."><?php echo htmlspecialchars($user['bio'] ?? '');
?></textarea>
            </div>
            <div class="form-group">
                <label class="checkbox-label">
                    <input type="checkbox" id="profileVideoCreator" <?php echo
$user['is_video_creator'] ? 'checked' : ''; ?>>
                    <span>Je souhaite créer du contenu vidéo (BookTok)</span>
                </label>
                <p class="form-help-text">Activez cette option pour pouvoir publier
des vidéos sur la plateforme</p>
            </div>
...
passe</button>
    ...
    <div class="profile-card danger-zone">
        ...
        <p class="danger-description">Une fois votre compte supprimé, toutes vos
données seront définitivement perdues.</p>
        <button class="btn btn-danger"
onclick="confirmDeleteAccount()">Supprimer mon compte</button>
    </div>
</div>
</body>
</html>